  ...
  return (
    <section className="about" id="about">
      ...
      >
        ...
        but mainly programming, blockchain, and cybersecurity. The greatest joy
        of my life is exploring how the world is becoming a better place to live
        through technological advancement, and I am so excited to be a part of
        it.
      </p>
    </section>
  );
